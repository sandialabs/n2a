...
public class UniformParamSpecDefPanel extends ParamSpecDefEditPanel {
    ...
    public UniformParamSpecDefPanel() {
        // TODO: This is really more of a class-level thing, but
        // how to get polymorphism to work at that level?
        UniformParameterSpecification spec = new UniformParameterSpecification(null, null);
    ...
    public ParameterSpecification getSpecification() {
        return new UniformParameterSpecification(
    ...
    public void setSpecification(ParameterSpecification spec) {
        UniformParameterSpecification espec = (UniformParameterSpecification) spec;
        txtStart.setText(espec.getStart().toString());
        txtEnd.setText(espec.getEnd().toString());
    }
}
