...
public class AllDatabasesPopupMenu extends JPopupMenu {
    private static OrientDbExplorerPanelUIController uiController;

    private TNode nActive;

    public AllDatabasesPopupMenu(OrientDbExplorerPanelUIController uic) {
        uiController = uic;
        init();
    }
    ...
    private void init() {
        JMenuItem mnuDatabaseAdd = new MMenuItem("&Add...", ImageUtil.getImage("add.gif"));
        mnuDatabaseAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                uiController.databaseAdd(nActive);
            }
        });
        add(mnuDatabaseAdd);
    }
