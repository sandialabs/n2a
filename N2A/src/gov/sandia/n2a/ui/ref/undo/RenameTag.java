...
public class RenameTag extends Undoable
{
    ...
    {
        super.undo ();
        PanelReference.instance.panelEntry.model.rename (key, exposedRow, after, before);
    }

    public void redo ()
    {
        super.redo ();
        PanelReference.instance.panelEntry.model.rename (key, exposedRow, before, after);
    }
}
