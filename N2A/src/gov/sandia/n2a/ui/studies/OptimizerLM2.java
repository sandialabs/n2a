...
/**
    An extension of OptimizerLM that solves the squared Jacobian (~J*J) rather than J directly.
    The matrix ~J*J tends to be much more compact than J for large sparse systems, since its
    size depends only on the number of variables rather than the number of data points.
    This also tends to be better conditioned than J. In particular, it can tolerate more
    zero elements in J and still solve for the next LM step.
**/
public class OptimizerLM2 extends OptimizerLM
{
