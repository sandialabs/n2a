...
//            if(row != -1) {
//                BeanBase bean = parentModel.getResult(row);
//                uiController.openExisting(PartX.class, bean.getId());
//            }
        } else {
//            int row = tblModels.getSelectedRow();
//            if(row != -1) {
//                BeanBase bean = modelModel.getResult(row);
//                uiController.openExisting(Model.class, bean.getId());
//            }
        }
    }
...
//        if(type == Type.PARENT) {
//            parentModel.setResults((List) children);
//        }
//    }
//    public void setModels(List<Model> models) {
//        if(type == Type.MODEL) {
//            modelModel.setResults((List) models);
//        }
//    }
}
