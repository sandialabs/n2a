...
public interface ImportSONATApart
{
    /**
        ...
        @param type Indicates whether this is a "node" or an "edge".
    ...
    **/
    public void processPart (ImportJob job, String partName, String type, String population, String model_template, List<String> instanceAttributes);
}
